...
# Returns true (0) if the first string (haystack), which is assumed to contain
# multiple lines, contains the second
#
# string (needle), and false (1) otherwise. The needle can contain regular
# expressions.
...
# Return true if the given response is empty or "null" (the latter is from
# jq parsing).
